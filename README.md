...
Parameter estimation for a nonlinear model using L1 minimization. This repo includes Python code to fit unknown variables to provided data, utilizing multi-start local/global optimization and residual analysis, with step-by-step procedure and results.

# Project Overview: 
The goal is to fit unknown parameters $\theta$, $M$, and $X$ in a nonlinear model to match provided $(x,y)$ data points using optimization methods.
...
![Fit Quality Visualization](images/output_curve_fitting.png)
